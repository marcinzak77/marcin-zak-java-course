...
public class CalculationsTest {
    ...
    private Map<Student, Grades> prepareData() {
        ...
        List<Integer> example1 = Arrays.asList(2, 3, 4, 5, 1); // 3.0
        List<Integer> example2 = Arrays.asList(2, 5, 5, 5, 5); // 4.4
        List<Integer> example3 = Arrays.asList(2, 3, 4, 5, 5, 5, 2); // 3.714285714285714
